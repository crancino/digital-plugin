...
// Newstype
$newstype = $this->el('div', [

    'class' => [
        'el-newstype',
        'uk-[text-{@newstype_style: newstype}]{newstype_style}',
        'uk-text-{newstype_color}',
        'uk-margin[-{newstype_margin}]-top {@!newstype_margin: remove}',
        'uk-margin-remove-bottom {@!newstype_style: |newstype} [uk-margin-{newstype_margin: remove}-top]',
    ],
...
<?php endif ?>
        ...
        <?php if ($props['newstype'] && $element['newstype_align'] == 'above-title') : ?>
        <?= $newstype($element, $props['newstype']) ?>
        <?php endif ?>
        ...
        <?php if ($props['newstype'] && $element['newstype_align'] == 'below-title') : ?>
        <?= $newstype($element, $props['newstype']) ?>
        <?php endif ?>
    ...
    <?php endif ?>
        ...
        <?php if ($props['newstype'] && $element['newstype_align'] == 'above-content') : ?>
        <?= $newstype($element, $props['newstype']) ?>
        <?php endif ?>
        ...
        <?php if ($props['newstype'] && $element['newstype_align'] == 'below-content') : ?>
        <?= $newstype($element, $props['newstype']) ?>
        <?php endif ?>
