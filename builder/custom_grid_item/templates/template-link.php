...
if ($link && $element['panel_link']) {
    ...
    $props['position'] = $this->striptags($props['position']);
    $props['date'] = $this->striptags($props['date']);
    $props['talk_title'] = $this->striptags($props['talk_title']);
    $props['tags'] = $this->striptags($props['tags']);
