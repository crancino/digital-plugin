...
return [
    ...
    'updates' => [
        ...
        '1.19.0-beta.0.1' => function ($node) {
            ...
            if (@$node->props['newstype_align'] === 'top') {
                $node->props['newstype_align'] = 'above-title';
            }

            if (@$node->props['newstype_align'] === 'bottom') {
                $node->props['newstype_align'] = 'below-title';
            }
        ...
        '1.18.10.3' => function ($node) {
            ...
            if (@$node->props['newstype_align'] === 'top') {
                if (!empty($node->props['newstype_margin'])) {
                    $node->props['title_margin'] = $node->props['newstype_margin'];
                }
                $node->props['newstype_margin'] = '';
            }
        ...
        '1.18.0' => function ($node) {
            ...
            if (!isset($node->props['newstype_color']) && @$node->props['newstype_style'] === 'muted') {
                $node->props['newstype_color'] = 'muted';
                $node->props['newstype_style'] = '';
            }
